...
ActiveRecord::Schema.define(version: 20160425151612) do
  ...
  create_table "next_steps", force: :cascade do |t|
    t.string "text_de", limit: 255, null: false
    t.string "text_en", limit: 255
    t.string "text_ar", limit: 255
    t.string "text_fr", limit: 255
    t.string "text_pl", limit: 255
    t.string "text_tr", limit: 255
    t.string "text_ru", limit: 255
  end
  ...
  create_table "offers", force: :cascade do |t|
    ...
    t.string   "treatment_type",              limit: 255
    t.string   "participant_structure",       limit: 255
    t.string   "gender_first_part_of_stamp",  limit: 255
    t.string   "gender_second_part_of_stamp", limit: 255
