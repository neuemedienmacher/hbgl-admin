...
class ProductivityGoal < ActiveRecord::Base
  class Create < Trailblazer::Operation
    step Model(::ProductivityGoal, :new)

    step Policy::Pundit(::ProductivityGoalPolicy, :create?)
  ...
  class Update < Trailblazer::Operation
    step Model(ProductivityGoal, :update)
    step Policy::Pundit(ProductivityGoalPolicy, :update?)
