...
export default class BurnUpChart extends React.Component {
  ...
  render() {
    ...
    const actualDeadline = svg.append('g').attr('class', 'deadline-group')
    actualDeadline
      .append('line')
    ...
    if (hasActiveCursor) {
      const xCoordLine = svg.append('g').attr('class', 'x coord line')
      xCoordLine
        .append('line')
      ...
      const yCoordLine = svg.append('g').attr('class', 'y coord line')
      yCoordLine
        .append('line')
        .style('stroke', 'lightgrey')
        .style('stroke-width', 1)
      ...
      const cursorPositionData = svg.append('g').attr('class', 'cursor_value')
