    ...
    return (
      ...
      >
        ...
        <table className='table History-What'>
          <thead>
            <tr>
              <td className='History_Tablehead--fieldname'>Feld-Name</td>
              <td className='History_Tablehead--valuebefore'>Wert vorher</td>
              <td className='History_Tablehead--valueafter'>Wert nachher</td>
            </tr>
          </thead>
          <tbody>{item.changes.map(this.renderHistoryChange.bind(this))}</tbody>
        </table>
      </div>
    )
  }
