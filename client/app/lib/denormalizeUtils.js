...
export function denormalizeStateEntity(entities, model, id, depth = 0) {
  ...
  if (entity) {
    forEach(entity, (value, key) => {
      if (isArray(value) && key.substr(-4) == '-ids') {
        ...
        let entityModel = entityModelForAssociation(
          entity,
          newModel,
          newModel,
          model
        ...
        denormalizedEntity[newModel] = denormalizeStateEntity(
          entities,
          entityModel,
          value,
          depth + 1
