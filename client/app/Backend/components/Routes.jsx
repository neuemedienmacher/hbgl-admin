...
import StandaloneGenericForm from '../../bundles/GenericForm/containers/Standalone'
import Export from '../../bundles/Export/containers/Export'
import DashboardContainer from '../../bundles/Dashboard/containers/DashboardContainer'
import NewAssignment from '../../bundles/NewAssignment/containers/NewAssignmentForm'
...
import OrgaTopicOverviewPage from '../../bundles/Statistics/components/OrgaTopicOverviewPage'
import OrgaScreeningOverviewPage from '../../bundles/Statistics/components/OrgaScreeningOverviewPage'
import OrgaOfferCitiesOverview from '../../bundles/Statistics/components/OrgaOfferCitiesOverviewPage'
import RatioOverviewPage from '../../bundles/Statistics/containers/RatioOverviewPage'
import EditTranslation from '../../bundles/EditTranslation/containers/EditTranslation'

import FederalStates from './v2/FederalStates'

const Routes = ({ initialSetup }) => {
  useEffect(() => {
    initialSetup()
  })
  ...
  return (
    <Router history={browserHistory}>
      <Route path='/' component={Layout}>
        ...
        <Route path='v2/federal-states'>
          <IndexRoute component={FederalStates} />
        </Route>
        ...
        <Route path='statistics' component={StatisticsLayout}>
          ...
          <Route
            ...
            component={OrgaScreeningOverviewPage}
          />
          <Route path='topic-overview' component={OrgaTopicOverviewPage} />
          <Route
            path='orga-offer-cities-overview'
