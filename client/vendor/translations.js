...
I18n.translations = {
  'en': {
    errors: {
      ...
      'max_size?': 'muss weniger als %{num} Zeichen enthalten',
      ...
      'size?': {
        arg: {
          ...
          range: 'muss %{size_left} - %{size_right} Zeichen enthalten',
        },
        value: {
          string: {
            arg: {
      ...
      'correct?': 'muss mit Passwort übereinstimmen',
      'unique?': 'darf noch nicht benutzt worden sein',
    },
  },
  'af': {
    errors: {
      ...
      template: {
        ...
        header: {
          ...
          other:
            '%{count} foute het verhoed dat hierdie %{model} gestoor kon word',
        },
      },
    },
  },
  'ar': {
    errors: {
      ...
      messages: {
        ...
        even: 'يجب أن يكون عددًا زوجيًّا',
        exclusion: 'محجوز',
    ...
    errors: {
      ...
      messages: {
        ...
        greater_than_or_equal_to:
          'трябва да има стойност, по-голяма или равна на %{count}',
        ...
        too_short:
          'е прекалено късо (не може да бъде по-малко от %{count} символа)',
        wrong_length:
          'е с грешна дължина (трябва да е с дължина, равна на %{count} символа)',
      },
      template: {
  ...
  'bs': {
    errors: {
      ...
      messages: {
        ...
        wrong_length:
          'je pogrešne dužine (trebalo bi biti tačno %{count} znakova)',
  ...
  'ca': {
    errors: {
      ...
      messages: {
        ...
        wrong_length:
          'no té la longitud correcta (%{count} caràcters exactament)',
      },
      template: {
        ...
        header: {
          ...
          other:
            "No s'ha pogut desar aquest/a %{model} perquè hi ha hagut %{count} errors",
        },
      },
    },
  },
    ...
    errors: {
      ...
      template: {
        ...
        header: {
          ...
          other:
            'Při ukládání objektu %{model} došlo ke %{count} chybám a nebylo možné jej uložit',
        },
      },
    },
  },
  'cy': {
    errors: {
      ...
      messages: {
        ...
        wrong_length:
          'gyda maint anghywir o lythrennau (dylai fod yn %{count} llythyren)',
      },
      template: {
  ...
  'da': {
    errors: {
      ...
      messages: {
        ...
        greater_than_or_equal_to:
          'skal være større end, eller lig med, %{count}',
  ...
  'el': {
    errors: {
      ...
      messages: {
        ...
        greater_than_or_equal_to:
          'πρέπει να είναι μεγαλύτερο ή ίσο με %{count}',
        ...
        too_long: {
          ...
          other:
            'είναι πολύ μεγάλο (το μέγιστο μήκος είναι %{count} χαρακτήρες)',
        },
        too_short: {
          one: 'είναι πολύ μικρό (το ελάχιστο μήκος είναι 1 χαρακτήρας)',
          other:
            'είναι πολύ μικρό (το ελάχιστο μήκος είναι %{count} χαρακτήρες)',
        },
        wrong_length: {
  ...
  'eo': {
    errors: {
      ...
      messages: {
        ...
        wrong_length:
          'ne estas je ĝusta longo (devas enhavi %{count} karakterojn)',
      },
      template: {
    ...
    errors: {
      ...
      messages: {
        ...
        wrong_length: {
          ...
          other:
            'no tiene la longitud correcta (debe ser de %{count} caracteres)',
        },
  ...
  'et': {
    errors: {
      ...
      messages: {
        ...
        greater_than_or_equal_to:
          'peab olema suurem või võrdne arvuga %{count}',
  ...
  'eu': {
    errors: {
      ...
      messages: {
        ...
        wrong_length:
          'ez du luzeera zuzena (%{count} karaktere izan behar ditu)',
      },
      template: {
        ...
        header: {
          ...
          other:
            '%{count} errorek ezinezkoa egiten dute %{model} hau gordetzea',
        },
      },
    },
  },
  ...
  'fi': {
    errors: {
      ...
      messages: {
        ...
        greater_than_or_equal_to:
          'täytyy olla suurempi tai yhtä suuri kuin %{count}',
        inclusion: 'ei löydy listasta',
        invalid: 'on kelvoton',
        less_than: 'täytyy olla pienempi kuin %{count}',
        less_than_or_equal_to:
          'täytyy olla pienempi tai yhtä suuri kuin %{count}',
        ...
        wrong_length:
          'on väärän pituinen (täytyy olla täsmälleen %{count} merkkiä)',
      },
      template: {
    ...
    errors: {
      ...
      template: {
        ...
        header: {
          ...
          other:
            '%{count} kesalahan mengakibatkan %{model} ini tidak bisa disimpan',
        },
      },
    },
  },
  'is': {
    errors: {
      ...
      messages: {
        ...
        greater_than_or_equal_to:
          'þarf að vera stærri en eða jafngilt %{count}',
    ...
    errors: {
      ...
      messages: {
        ...
        wrong_length: {
          ...
          other:
            'è della lunghezza sbagliata (deve essere di %{count} caratteri)',
        },
      },
      template: {
  ...
  'mk': {
    errors: {
      ...
      messages: {
        ...
        greater_than_or_equal_to:
          'мора да биде поголемо или еднакво на %{count}',
  ...
  'mr-IN': {
    errors: {
      ...
      messages: {
        ...
        greater_than_or_equal_to:
          '%{count} पेक्षा मोठे किंवा समान असणे आवश्यक आहे',
      ...
      template: {
        ...
        header: {
          ...
          other:
            '%{count} चुका ह्या %{model} ला जतन करण्यापासून प्रतिबंधित करत आहे',
        },
      },
    },
  },
  'ms': {
    errors: {
      ...
      messages: {
        ...
        less_than_or_equal_to:
          'mesti kurang daripada atat sama dengan %{count}',
        ...
        wrong_length: {
          ...
          other:
            'mempunyai panjang yang salah(sepatutnya %{count} karakter sahaja)',
        },
      },
      template: {
  ...
  'ro': {
    errors: {
      ...
      messages: {
        ...
        greater_than_or_equal_to:
          'trebuie să fie mai mare sau egal cu %{count}',
        ...
        wrong_length:
          'nu are lungimea corectă (trebuie să aiba %{count} caractere)',
      },
      template: {
  ...
  'ru': {
    errors: {
      ...
      messages: {
        ...
        less_than_or_equal_to:
          'может иметь значение меньшее или равное %{count}',
    ...
    errors: {
      ...
      template: {
        ...
        header: {
          ...
          other:
            'Pri ukladaní objektu %{model} došlo k %{count} chybám a nebolo ho možné uložiť',
        },
      },
    },
  },
    ...
    errors: {
      ...
      template: {
        ...
        header: {
          ...
          other:
            "%{count} veprime të gabuara e ndaluan këtë %{model} për t'u ruajtur",
        },
      },
    },
  },
  ...
  'ta': {
    errors: {
      ...
      messages: {
        ...
        greater_than_or_equal_to:
          '%{count}  அதிகமாக அல்லது சமமாக இருக்க வேண்டும்',
        ...
        too_short: {
          ...
          other:
            'மிகவும் குறுகியதாக உள்ளது (குறைந்தபட்சம் %{count} எழுத்துக்கள்)',
        },
        wrong_length: {
  ...
  'tl': {
    errors: {
      ...
      messages: {
        ...
        greater_than_or_equal_to:
          'dapat na mas higit sa o katumbas ng %{count}',
      ...
      template: {
        header: {
          ...
          other:
            'hindi maaaring i-save ang %{model} na ito dahil sa %{count} error',
        },
    ...
    errors: {
      ...
      messages: {
        ...
        too_long: {
          ...
          other:
            'бигрәк озын (озынлыгы %{count} мәгнәсеннән озынрак була алмый)',
        },
        too_short: {
          one: 'бигрәк кыска (озынлыгы бердән кыскарак була алмый)',
          other:
            'бигрәк кыска (озынлыгы %{count} мәгнәсеннән кыскарак була алмый)',
        },
        wrong_length: {
          one: 'озынлыгы ялгыш (озынлыгы бергә тигез булырга тиеш)',
          other:
            'озынлыгы ялгыш (озынлыгы %{count} мәгнәгә тигез булырга тиеш)',
        },
    ...
    errors: {
      ...
      messages: {
        ...
        too_long: {
          ...
          other:
            'uzunligi yetarligidan ortiq (%{count} ta simvoldan yuqori mumkin emas)',
        },
        too_short: {
          ...
          other:
            'uzunligi yetarli emas (%{count} ta simvoldan kam mumkin emas)',
        },
        wrong_length: {
          ...
          other:
            'uzunligi notugri (uzunligi %{count} simvolga teng bulishi kerak)',
        },
      },
      template: {
